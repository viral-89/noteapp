...
const App = () => {
  ...
  return (
    ...
    <div className='bg-black/70 max-w-sm p-2 rounded-3xl shadow-2xl'>
      ...
      <input type="text" className='w-full px-4 py-2 bg-[#222] rounded-md my-2 text-white font-semibold outline-none focus:ring-2 focus:ring-white' placeholder='Heading' value={Title} onChange={(e) => {
      ...
      <input type="submit" value="Add Task" className='w-full bg-white text-black rounded-md font-semibold px-4 py-2 my-2 active:scale-95 active:bg-white/50 active:text-white outline-none focus:ring-2 focus:ring-white'/>
      </form>
    </div>
    </div>
    ...
    {Tasks.map((task, id) => {
      return (
         ...
         <img src="./pin.png" alt="" className='w-15 h-10 absolute z-10 top-2'/>
